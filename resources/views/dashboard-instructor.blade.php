...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title> Escritorio Instructor</title>
        <!-- Fonts -->
        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <div style="color: white; width:800px; height: 400px;background-color: rgba(0,0,0,.5);opacity: 0.9; border-radius: 10px;padding: 20px;">
                    ...
                    <a class="btn btn-secondary active" type="button" href="{{url('horario')}}" style="line-height: 27px;"><strong>Mi Horario Semanal</strong></a>
                    <a class="btn btn-secondary active" type="button" href="{{url('users/info')}}" style="line-height: 27px;"><strong>Mi Información</strong></a>
                </div>
            </div>
        </div>
