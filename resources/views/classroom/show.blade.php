...
<body>
	...
	<div class="col-md-6 offset-3">
		<h1 class="text-center" style="font-size: 30px"><i class="fa fa-search"></i> Consultar Ambientes</h1>
		<hr>
		<ol class="breadcrumb">
		...
		<table class="table table-striped table-hover text-center">
			...
			<tr>
				<th> Estado: </th>
				<td> {{ $classroom->state }}</td>				
			</tr>
			<tr>
				<th> Uso: </th>
				<td> {{ $classroom->usability }}</td>
			</tr>
		</table>
