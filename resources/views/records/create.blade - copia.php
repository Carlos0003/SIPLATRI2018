		...
		<form action="{{url('record')}}" method="post" enctype="multipart/form-data">
			...
			<table class="col-md-12" border="1px solid black" style="font-size: 12px;">
				...
				{{-- PRIMERA CLASE DIA A DIA --}}
					...
					<td style="font-size: 12px; width:200px; border: 1px solid black; background-color: #AEB6BF;" rowspan="2" class="text-center"><input type="time" id="hora_desde" name="hora_inicio_PLunes" style="width: 200px; font-size: 12px; border-style: none; text-align: center;background-color: #AEB6BF;">
					</td>
					<td style="font-size: 12px; width:200px; border: 1px solid black; background-color: #AEB6BF;" rowspan="2" class="text-center"><input type="time" id="hora_hasta" name="hora_fin_PLunes" style="width: 200px; font-size: 12px; border-style: none; text-align: center;background-color: #AEB6BF;"></td>
				...
				<tr>
					...
					<td style="font-size: 12px; width:200px; border: 1px solid black; background-color: #AEB6BF;" rowspan="2" class="text-center"><input type="time" name="hora_inicio_SLunes" id="hora_inicio_SLunes" style="width: 200px; font-size: 12px; border-style: none; text-align: center;background-color: #AEB6BF;"></td>
					<td style="font-size: 12px; width:200px; border: 1px solid black; background-color: #AEB6BF;" rowspan="2" class="text-center"><input type="time" name="hora_fin_SLunes" id="hora_fin_SLunes" style="width: 200px; font-size: 12px; border-style: none; text-align: center;background-color: #AEB6BF;"></td>
					<td style="font-size: 12px; width:200px; border: 1px solid black; background-color: #AEB6BF;">
					...
					<td style="font-size: 12px; width:200px; border: 1px solid black; background-color: #AEB6BF;">
						<select id="classrooms_SLunes_id" style="width: 190px; font-size: 12px; background-color: #AEB6BF;"  name="classrooms_SLunes_id" class="form-control">
							<option value="">Seleccione Ambientes...</option>
							@foreach($classrooms as $class)
								<option value="{{ $class->id }}">{{ $class->name }}</option>
							@endforeach
	 ...
	 $('form').on('change','#programaFormacionTable', function(event) {
	 		...
	 		$('form').on('change','#hora_hasta', function(event) {
                    ...
                    $.ajax({
                        ...
                        data:{'dateDesde':$dateDesde, 'dateHasta':$dateHasta},

                        success:function(data){
                            // $('#pruebaSelect option').removeClass("mostrar");
	 		...
	 		$('form').on('change','#hora_fin_SLunes', function(event) {
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                        	console.log(data);
							console.log('entro');
                            // $('#classrooms_SLunes_id option').removeClass("mostrar");

                            for (var i = 0; i < data.length; i++) {

                                // $op+= '<option value="'+data[i].type+'">'+data[i].timeduration+'</option>';
                                $('#classrooms_SLunes_id option[value="'+data[i].classrooms_SLunes_id+'"]').hide();
                                console.log(data[i].classrooms_SLunes_id);
                            }
                        },
                        error:function(){
